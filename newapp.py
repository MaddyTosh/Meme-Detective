...
SLANG_PATH = r"C:\Users\samee\Desktop\summer project\slang.txt"
...
#================================= Title Image ===========================
st.text("""""")
img_path_list = [r"C:\Users\samee\Desktop\summer project\image_1.jpg", r"C:\Users\samee\Desktop\summer project\image_2.jpg"]
...
🔘 **NOTE :** *If you upload other than an image file/txt file, then it will show an error message when you will click the* **👉🏼 Predict** *button!!!*
	""")
...
## 3️⃣ What It Will Predict
	""")
st.write("""
Well, it can predict whether the image you have uploaded is the HateFul 😠 or Not-Hateful 🤪?
	""")
...
#============================ Download Clicked =============================
if download:
	link = "https://drive.google.com/drive/folders/1yGxvJkjQ910lDLgcl8_UeLVnJY-eLxhQ"
	try:
...
def load_model():
  ...
  checkpoint_path = r"C:\Users\samee\Desktop\summer project\checkpoints"
...
st.text("""""")
st.write("""
### ©️ Created By Madhavan and Vishal
	""")